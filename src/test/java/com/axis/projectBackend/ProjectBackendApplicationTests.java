package com.axis.projectBackend;
...
import com.axis.projectBackend.controller.CategoryController;
import com.axis.projectBackend.controller.ProductController;
...
@SpringBootTest(classes = com.axis.projectBackend.ProjectBackendApplication.class,
...
class ProjectBackendApplicationTests {
	...
	//Product a =new Product(null, null, 0, null, null, null);
	...
	Set<Product> catProduct =new HashSet<Product>();
	...
	public void setup3() {
		...
		cartController.setCartService(categoryService);
		mockMvc1= MockMvcBuilders.standaloneSetup(categoryController).build();
	}
	Product product1= new Product("oil", "www.facebook.com", 2.5, "Cooking oil", null, 0);
	Set<Product> catProduct =new HashSet<Product>();
